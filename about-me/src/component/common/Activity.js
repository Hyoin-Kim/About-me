        ...
        <nav className="skills__main">
          ...
          <div className="skills__detail">
            <div className="skills__content">
              <span className="skills__date">2017.03 - 2022.02</span>서울여자대학교 정보보호학과 입학 및 졸업 예정
            </div>
            <div className="skills__content">
              <span className="skills__date">2018.07 - 2018.08 </span>Programming Guru1 수료 (HTML, PYTHON, UNITY 단기
              프로젝트 진행)
            </div>
            <div className="skills__content">
              <span className="skills__date">2018.08 - 2019.12 </span>서울여자대학교 정보보호학과 리눅스 소학회 SWLUG
              활동
            </div>
            <div className="skills__content">
            ...
            <div className="skills__content">
              <span className="skills__date">2020.07 - 2020.08 </span>예쉬컴퍼니 VR 기획 및 개발 인턴 수료{" "}
            </div>
            <div className="skills__content">
              <span className="skills__date">2021.03 - 2021.07 </span>IT 연합 창업동아리 SOPT 28기 Web 수료
            </div>
            <div className="skills__content">
              <span className="skills__date-ing">2021.09 - ing</span>IT 연합 창업동아리 SOPT 29기 Web 활동 중
            </div>
            <div className="skills__footer">
              <div className="skills__footer-detail">
                {" "}
                스스로 문제를 찾아 고민하고, 정의하고, 해결할 수 있는 능력을 갖춘,
              </div>
              <div className="skills__footer-detail">
                {" "}
                서비스 플랫폼 개발자 <span className="skills__name">“김효인”</span> 이 되겠습니다.
              </div>
            </div>
          </div>
        </nav>
