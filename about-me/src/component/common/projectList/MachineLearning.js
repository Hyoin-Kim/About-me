            ...
            <MlWrapper>
                    <div className="ml">
                        <div className="ml__main">
                            <img className="ml__img" src={netChallenge} alt="" onClick={()=>{mlHandleModal()}}/>
                            ...
                            <Modal>
                                <ModalWrapper>
                                    ...
                                    <div className="text">
                                        ...
                                        <p>개인정보 보호를 위한 영상에 행인이 포함될 때 자동 <span className="modal__mlTitle">Masking 되도록 개발, 구축</span>하였습니다.</p>
