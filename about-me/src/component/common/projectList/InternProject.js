        ...
        <Modal>
          <ModalWrapper>
            ...
            <div className="text">
              ...
              <p>
                <span>2020.07~2020.08 기간동안 근무하면서</span> VR 콘텐츠를 자체 기획하고 디자인, 개발하여 실제
                VR존에서 체험가능한 영상물입니다.
              </p>
              <p>
                <span className="modal__mlTitle">VR 시뮬레이터 연동 롤러코스터 컨셉 기획</span> 및 컨셉에 맞는 그래픽
                에셋 자료조사를 하였으며,{" "}
              </p>
              ...
              <p>
                <span>단기간에 Unity활용법과 C#에 대해 공부</span> 해볼수 있었던 계기가 되었으며, 처음부터 끝 마무리까지
                책임감 있게 작업하여 좋은 결과물을 낼수 있었습니다.{" "}
              </p>
            </div>
            <img
              className="closeIcon"
