              ...
              <ModalWrapper>
                ...
                <div className="text">
                  ...
                  <h5 className="modal__subtitle">
                    타인과의 정보를 공유하여 성장하고 마침내 성공적인 결과를 만들어 낼 수 있는 가치 추구
                  </h5>
                  <hr className="modal__hr" />
                  <p>
                    창업가들, 예비창업가들의 앞으로 펼쳐질 창업을 위한{" "}
                    <span className="modal__o2Title">회고 커뮤니티 사이트</span>입니다.
                  </p>
                  <p>
                    LearnMyself를 통해 회고 이야기를 공유할 수 있고, ShareTogether을 통해 창업가들의 성공 스토리를
                    공유할 수 있습니다.
                  </p>
                  <p>
                    <span>기획,디자인,서버,웹파트원과 협업한 장기 프로젝트</span>이며, 지금도 꾸준히 개발, QA, 운영하고
                    있습니다.
                  </p>
                  <p>
                    <span>React, Typescript</span>로 개발하였으며, 리팩토링과 함께 <span>Atomic Design과 NextJS </span>
                    적용하였습니다.
                  </p>
                  <p>
                    메인페이지(#1), LearnMyself(#2), ShareTogether(#3), 마이페이지(#4), 관리자 페이지(#7, #8) 등 약
                    20개의 뷰 구현하였으며
                    <span className="modal__o2Title"> 최우수상</span>을 수상하였습니다.
                  </p>
                </div>
                <img
                  className="closeIcon"
            ...
            <Modal>
              <ModalWrapper>
                ...
                <div className="text">
                  ...
                  <hr className="modal__hr" />
                  <p>
                    오늘 하루에 대한 질문이 날아오면 3초안에 대답해야하는{" "}
                    <span className="modal__o2Title">나만의 일기 웹서비스</span> 입니다.
                  </p>
                  <p>
                    게임 시작과 함게 질문, 3초안에 대답을 못할시 랜덤 답변이 주어지며, 결과 이미지에 대한 저장 및 그룹
                    공유가 가능합니다.
                  </p>
                  <p>
                    <span>기획,디자인,서버,웹파트원과 협업한 무박2일 해커톤 프로젝트</span>이며,{" "}
                    <span> '기억'을 주제로' 아이데이션 뿐만 아니라 기획 일부</span>에도 참여하였습니다.
                  </p>
                  <p>
                    <span>React, Javascript를 활용</span>하여 개발하였으며, 끊임없는 소통과 협업을 통해{" "}
                    <span className="modal__o2Title">대상</span>을 수상하였습니다.
                  </p>
                </div>
                <img
                  className="closeIcon"
            ...
            <Modal>
              <ModalWrapper>
                ...
                <div className="text">
                  ...
                  <h5 className="modal__subtitle">
                    간단한 자기소개, 인적 사항, 보유 기술 스택, 프로젝트/협업 경험, GitHub/velog 링크 등
                  </h5>
                  <hr className="modal__hr" />
                  <p>
                    포트폴리오 용도로 제작한 <span className="modal__o2Title">React/JS 기반의 웹 사이트</span>입니다.
                  </p>
                  <p>지금 보고 있는 웹 사이트에 해당합니다.</p>
                  <p>프론트엔드 공부와 더불어 배포 경험도 해볼 수 있었던 프로젝트 입니다. </p>
                  <p>
                    <span>React, Javascript, bootstrap를 활용</span>하여 개발하였습니다.
                  </p>
                  <p></p>
                  <p></p>
                </div>
            ...
            <Modal>
              <ModalWrapper>
                ...
                <div>
                  ...
                  <hr className="modal__hr" />
                  <p>
                    IT 연합 창업동아리 SOPT 세미나, React 스터디에서 진행한{" "}
                  ...
                  <p>
                    <span>
                      React, Javascript를 활용하여 개발하였으며, 프론트엔드의 전반적인 공부를 하는데 좋은 경험
                    </span>
                    이 되었습니다.
                  </p>
                </div>
